	...
	<div class="row">
		<div class="col-md-8"><h1>PROFIL <?php echo strtoupper($company->company_name) ?></h1><hr>
			<p align="center"><?php
				...
				else { echo " <img style='width: 400px; height: 400px; margin-bottom: 20px;' src='".base_url()."assets/images/company/".$company->foto.$company->foto_type."' class='img-responsive' title='$company->company_name' alt='$company->company_name'> ";}
				?>
			</p>
